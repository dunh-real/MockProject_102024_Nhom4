...
import { Rate, Pagination } from 'antd'; // Nhập Pagination từ antd
...
const reviews: Review[] = [
    ...
    },
    {
        ...
        renter: 'Verified Renter',
        text: 'The location of Presidential Towers makes it perfect for a young couple to stay without a vehicle. The amenities and facilities are appropriately located, the maintenance is super fast.',
        managerResponse: 'Property Manager Responded October 20, 2024',
        helpfulCount: 2,
    },
];
...
const ReviewList: React.FC = () => {
    ...
    const pageSize = 3; // Số lượng đánh giá mỗi trang
                ...
                <div className="lg:w-4/5 p-4 sm:p-6 bg-white">
                    ...
                    <div className="flex justify-center mt-3 mb-5">
                        <Pagination
                            ...
                            showSizeChanger={false} // Ẩn chức năng thay đổi số lượng item trên trang
                        />
                    </div>
                </div>
            </div>
