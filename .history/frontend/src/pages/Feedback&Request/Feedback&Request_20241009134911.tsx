            ...
            <div className="flex">
                ...
                <div className="w-4/5 p-6 bg-white">
                    ...
                    <div className="flex  justify-around items-center mb-6">
                        ...
                        <div className='bg-[#d9d9d97b] flex justify-between'
                            style={{ width: '100%', maxWidth: '700px', padding: 40, lineHeight: 1 }}
                        >
                            <div className="ml-4 ">
                                <Rate allowHalf defaultValue={4.5} disabled style={{ color: '#F8A869' }} />
                                <div className="text-[#000000] mt-2 mb-2 text-[22px]">4.5 Blended Score</div>
                                <div className="text-[#000000]  font-extralight text-[22px]">77 Renter Reviews</div>
                            </div>
                            <div className=''>
                                <p className='text-[#000000] font-extralight text-[20px] leading-7'>Share details of your own experience <br />
                                    with this property</p>
                                <button
                                    onClick={() => setShowModal(true)}
                                    className="bg-[#f05a28] text-white px-12 py-3 mt-3 rounded hover:bg-[#ff6a38] hover:text-black "
                                >
                                    Write a Review
                                </button>
                            </div>
                            ...
                            <div key={index} className="p-4 border border-gray-200 rounded-lg bg-white shadow">
                                <div className="flex justify-between items-center mb-2">
                                    <div>
                                        ...
                                        <p className='text-[15px] font-light' >{review.renter}</p>
                                    </div>
