        ...
        <div className=" min-h-screen  bg-gray-50">
            ...
            <div className="flex">
                ...
                <div className="w-4/5 p-6 bg-white">
                    ...
                    <div className="flex border-2 justify-around items-center mb-6">
                        ...
                        <div className='bg-[#d9d9d995] flex justify-around'
                         style={{ width: '100%', height:'100px', maxWidth: '650px', maxHeight:'120px' }}
                        >
                            <div className="ml-4 ">
