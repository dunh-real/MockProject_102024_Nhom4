...
const ReviewList: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <div className="w-1/5 h-screen bg-[#f5e6dc] p-4">
          <ul>
            <li className="py-2 font-bold hover:bg-[#fbc7a7] cursor-pointer">Apartments</li>
            <li className="py-2 font-bold hover:bg-[#fbc7a7] cursor-pointer">Work Schedule</li>
            <li className="py-2 font-bold hover:bg-[#fbc7a7] bg-[#f05a28] text-white cursor-pointer">
              Feedback & Request
            </li>
            <li className="py-2 font-bold hover:bg-[#fbc7a7] cursor-pointer">Legal Documents</li>
            <li className="py-2 font-bold hover:bg-[#fbc7a7] cursor-pointer">Contract Information</li>
            <li className="py-2 font-bold hover:bg-[#fbc7a7] cursor-pointer">Training</li>
          </ul>
        </div>
        ...
        <div className="w-4/5 p-6 bg-white">
          ...
          <div className="flex justify-end">
            <img
              src="https://via.placeholder.com/40" // Avatar mẫu, thay bằng ảnh người dùng
              alt="Avatar"
