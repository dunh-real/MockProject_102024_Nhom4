                ...
                <div className="w-4/5 p-6 bg-white">
                    ...
                    <div className="flex  justify-around items-center mb-6">
                        ...
                        >
                            ...
                            <div className=''>
                                <p className='text-[#000000] font-extralight text-[20px]'>Share details of your own experience <br/>
                                with this property</p>
                                <button
                                    onClick={() => setShowModal(true)}
                                    className="bg-[#f05a28] text-white px-[55px] py-3 mt-3 rounded hover:bg-[#ff6a38] hover:text-black "
                                >
                                    Write a Review
                                </button>
                            </div>
