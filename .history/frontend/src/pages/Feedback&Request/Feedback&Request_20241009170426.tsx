...
const reviews: Review[] = [
    ...
    // Thêm nhiều đánh giá hơn nếu cần
];

const ReviewList: React.FC = () => {
    const [showModal, setShowModal] = useState<boolean>(false);
    const [page, setPage] = useState<number>(1);
    const reviewsPerPage = 3; // Số lượng đánh giá trên mỗi trang
            ...
            <div className="flex flex-row lg:flex-row">
                ...
                <div className="lg:w-4/5 p-4 sm:p-6 bg-white">
                    ...
                    <div className="flex justify-center mt-3 mb-5">
                        ...
                        <span className="mx-2 text-sm sm:text-base">{`Page ${page} of ${totalPages}`}</span>
                        <button
                            onClick={() => handlePageChange(page + 1)}
                            className="px-4 py-2 text-gray-500 text-sm sm:text-base"
