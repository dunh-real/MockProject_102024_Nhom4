                ...
                <div className="max-w-xl w-full px-4 sm:px-8 shadow-[0px_5px_25px_5px_rgba(0,0,0,0.3)] rounded-lg">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mb-5">
                        <div className="flex flex-col md:flex-row md:items-start mb-4">
                            <label className="block text-sm font-semibold mb-1 md:mb-0 md:w-1/3 md:text-right">Email Address</label>
                        ...
                        <div className="flex flex-col md:flex-row md:items-start mb-4">
                            <label className="block text-sm font-semibold mb-1 md:mb-0 md:w-1/3 md:text-right">Password</label>
                            <div className="md:w-2/3">
                                <Input.Password
                                    className="focus:border-black"
                                    style={{ width: '100%', maxWidth: '480px' }}
