        ...
        <div className="min-h-screen flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 bg-white flex justify-center items-center p-6">
                <div className="max-w-xl w-full px-4 sm:px-8 shadow-[0px_5px_25px_5px_rgba(0,0,0,0.3)] rounded-lg">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mb-5 flex flex-col items-center"> 
                        <div className="w-full flex flex-col items-center"> 
                            <label className="block flex justify-start text-sm font-semibold mb-1">Email Address</label>
                            <Input
