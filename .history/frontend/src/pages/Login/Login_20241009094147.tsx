...
const LoginForm = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row">
            ...
            {/* Left side image */}
            <div className="w-full md:w-1/2 bg-gray-900 flex justify-center items-center p-6 bg-cover bg-center" style={{ backgroundImage: `url(${ChungCu})` }}>
                {/* Empty content; only background image */}
            </div>
