    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 bg-white flex justify-center items-center p-6">
                <div className="max-w-xl w-full px-4 sm:px-8 shadow-[0px_5px_25px_5px_rgba(0,0,0,0.3)] rounded-lg">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mb-5 flex flex-col items-center"> {/* Center the form items */}
                        <div className="w-full flex flex-col items-center"> {/* Center the email input container */}
                            ...
                            />
                            {errors.email && <p className="text-red-500 text-xs mt-1 text-center">{errors.email.message}</p>}
                        </div>
                        <div className="w-full flex flex-col items-center"> {/* Center the password input container */}
                        ...
                        <div className="w-full flex justify-center"> {/* Center the button container */}
                            <Button type="primary" htmlType="submit" className="w-full" style={{ maxWidth: '480px' }}>
                                Sign In
                            </Button>
                        </div>
                    </form>
