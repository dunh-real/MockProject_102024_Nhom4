            ...
            <div className="flex">
                <div className="mb-4 w-1/3 ">
                    {ratingLabels.map((item) => (
                        <div
                            key={item.star}
                            className={`flex flex-col justify-between p-2 mb-2 cursor-pointer rounded-md ${rating === item.star ? 'bg-orange-100' : 'bg-gray-100'
                                }`}
                        ...
                        >
                            ...
                            <span className="text-sm mt-3">{item.label}</span>
                        </div>
                    ))}
                </div>
