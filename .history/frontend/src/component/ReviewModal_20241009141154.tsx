    ...
    return (
        ...
        >
            <div className='flex justify-between'>
                <div className="mb-4 p-5 w-1/2 pr-4">
                ...
                <div className="w-1/2">
                    <label htmlFor="" className="block mb-2 font-medium">Headline</label>
                    <Input
                        ...
                        className="mb-4"
                    />
                    <label htmlFor="" className="block mb-2 font-medium">Your Review</label>
                    <Input.TextArea
