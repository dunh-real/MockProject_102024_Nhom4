...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
    const [profileImage, setProfileImage] = useState<string>("https://png.pngtree.com/png-clipart/20190117/ourlarge/pngtree-financial-manager-character-rising-data-illustration-png-image_432606.jpg");
