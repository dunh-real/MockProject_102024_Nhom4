      ...
      <div>
        <div className="w-screen h-screen flex flex-col lg:flex-row gap-5 lg:gap-0 justify-center items-center">
          <div className="hidden lg:basis-1/2 bg-dark lg:h-full lg:flex flex-col justify-center items-center">
            <img
              className="h-screen"
              src="https://www.rabideaulaw.ca/wp-content/uploads/pexels-expect-best-323705.jpg"
            />
          </div>

          <div className="lg:basis-1/2 dark:bg-white dark:text-dark flex lg:flex-row items-center">
            <div className="lg:w-7/12 w-screen px-4 lg:mt-0 lg:px-0 mx-auto">
              <div className="lg:hidden flex-col items-center">
                <img
                  className="h-full w-screen"
                  src="src\assets\logo_5562213.png"
                />
              </div>

              <div className="text-3xl font-bold mb-6 text-blue-600 sm: flex justify-center mt-4">
                Sign In
              </div>
              ...
              <div className="mt-2">
                <a
                  href="#"
                  className="flex justify-center text-sm text-gray-500 italic underline"
                >
                  Forget Password
                </a>
              </div>
